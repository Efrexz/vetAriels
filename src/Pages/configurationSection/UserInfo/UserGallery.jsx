    ...
    return (
        <div className="p-4 w-full">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4">
                <label htmlFor="file" className="cursor-pointer w-full md:w-[75%] px-4 py-2  border rounded-lg text-gray-500 text-center">
                ...
                <button
                    ...
                    className="bg-green-500 w-full md:w-auto hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center w-[25%]"
                >
