...
function ServiceInfo() {
    const { servicesData, updateServiceData } = useContext(ProductsAndServicesContext);
    ...
    return (
        <main className="w-full mx-auto p-6 bg-white">
            <h2 className="text-2xl font-medium mb-4 border-b-2 border-gray-200 pb-3 text-blue-400 flex gap-1 align-center" >
                <PillsIcon className="w-7 h-7 mr-2" />
