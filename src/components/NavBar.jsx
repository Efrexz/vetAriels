...
function NavBar() {
    const pageSections = [
        { icon: SearchIcon, tooltip: 'Buscar Propietarios o mascotas' },
        { icon: NewUserIcon, tooltip: 'Crear nuevo Propietario' },
        { icon: Stethoscope, tooltip: 'Sala de espera' },
        { icon: BathIcon, tooltip: 'Peluqueria' },
    ];
