...
function NavBar() {
    ...
    return (
        <nav className='flex justify-between items-center py-3 px-4 md:px-8 w-full bg-gray-800 text-gray-300 shadow-lg fixed z-40'>
            <Link
                to="/"
            ...
            >
                <h1 className="text-sm lg:text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-emerald-400">
