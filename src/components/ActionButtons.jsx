...
function ActionButtons({
    ...
    return (
        <div className={`flex flex-col xs:flex-row ${mode === "modal" ? "justify-end space-x-4" : "justify-between items-center bg-gray-100 py-3 px-4 shadow-lg rounded-b-lg gap-4"}`}>
            <button
